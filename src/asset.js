...
export class Asset {
    /**
     * Asset class represents an asset, either the native asset (`ACTN`)
     * or a asset code / issuer account ID pair.
     *
     * An asset code describes an asset code and issuer pair. In the case of the native
     * asset ACTN, the issuer will be null.
     *
     * @constructor
    ...
    constructor(code, issuer) {
      ...
      if (String(code).toLowerCase() !== "actn" && !issuer) {
