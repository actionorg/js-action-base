...
export class Operation {
   ...
   * @param {string} opts.startingBalance - Amount in ACTN the account should be funded for. Must be greater
   ...
   * destination account, optionally through a path. ACTN payments create the destination
